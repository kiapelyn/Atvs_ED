# respeite ordem de chegada, MAS pacientes em estado GRAVE passam na frente
class No:
...
def main():
    while True:
        ...
        match op:
            ...
            case 2:
                atendimento = lista.atender(dado)
                print(f"Paciente {atendimento[0]} sendo atendido")
            case 3:
                lista.imprimir()
            case 4:
                nome, posi = lista.buscar(input("Nome do paciente: "))
